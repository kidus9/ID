...
label_heading = canvas.create_text(200,20, font=('Oswald', '24', 'bold italic') ,text="Driving License", fill = "white")
label_id_tag = canvas.create_text(25,60, font=("Times", '14', 'bold') ,text="ID : 19827198349")
label_name_tag = canvas.create_text(30,100, font=('Times', '12', 'bold') ,text="Name: Alemberhan, Kidus, Daniel")
label_dob_tag = canvas.create_text(52,120, font=('Times', '12', 'bold') ,text="Date of birth: 01|27|2003")
label_pin_tag = canvas.create_text(32,140, font=('Times', '12', 'bold') ,text="Pin no.: 103 848")
label_address_tag = canvas.create_text(36,160, font=('Times', '12', 'bold') ,text="Address: 233 Mott St, New York, NY, 10002")
label_vehicle_type_tag = canvas.create_text(155,180, font=('Times', '12', 'bold') ,text="Authorisation to drive the following vehicles : Car, ATV, Motorcycle, RV, and Truck")
